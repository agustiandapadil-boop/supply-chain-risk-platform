    ...
    <form action="{{ route('ports.update', $port->id) }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="harbor_size" name="harbor_size" value="{{ old('harbor_size', $port->harbor_size) }}">
            </div>

            <div class="col-md-6">
                <label for="harbor_type" class="form-label">Harbor Type</label>
                <input type="text" class="form-control" id="harbor_type" name="harbor_type" value="{{ old('harbor_type', $port->harbor_type) }}">
            </div>

            <div class="col-md-6">
                <label for="latitude" class="form-label">Latitude</label>
                <input type="text" class="form-control" id="latitude" name="latitude" value="{{ old('latitude', $port->latitude) }}">
            </div>

            <div class="col-md-6">
                <label for="longitude" class="form-label">Longitude</label>
                <input type="text" class="form-control" id="longitude" name="longitude" value="{{ old('longitude', $port->longitude) }}">
            </div>
